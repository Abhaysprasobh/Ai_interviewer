      ...
      <div className="w-full md:w-1/2 p-12 flex items-center justify-center">
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            <h2 className="text-3xl text-slate-700 font-bold mb-2">Company Registration</h2>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 text-slate-700 py-3 border rounded-xl"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  onChange={handleInputChange}
                  className="w-full pl-10 py-3 text-slate-700 border rounded-xl"
