                ...
                <div className="space-y-1">
                    ...
                    <div className="relative">
                        ...
                        <input 
                            ...
                            type="text" 
                            required
                            className="block w-full pl-10 pr-3 py-3 border border-slate-200 text-slate-700 rounded-xl focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all"
                ...
                <div className="space-y-1">
                    ...
                    <div className="relative">
                        ...
                        <input 
                            ...
                            type="email" 
                            required
                            className="block w-full pl-10 pr-3 py-3 border text-slate-700 border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all"
                ...
                <div className="space-y-1">
                    ...
                    <div className="relative">
                        ...
                        <input 
                            ...
                            type="tel" 
                            required
                            className="block w-full pl-10 pr-3 py-3 text-slate-700 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all"
