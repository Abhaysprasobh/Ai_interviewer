...
export default function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Optional: Store user email for personalization
      ...
      <div className="hidden md:flex md:w-1/2 bg-slate-900 relative flex-col justify-between p-12 text-white">
        ...
        <div className="relative z-10 space-y-6">
            ...
            <p className="text-slate-400 text-lg max-w-sm">
                Get real-time feedback, mock questions, and resume analysis powered by Gemini & Vosk AI.
            </p>
        ...
        <div className="max-w-md mx-auto w-full">
            ...
            <div className="mt-8 text-center">
                <p className="text-sm text-slate-500">
                    New here?{' '}
                    <Link href="/register" className="text-indigo-600 font-medium hover:underline transition-all">
                        Create an account
                    </Link>
                </p>
            </div>
