        ...
        <div className="landing">
            ...
            <section className="hero">
                <div className="container">
                    ...
                    <p className="hero-subtitle">Connect talented professionals with companies through intelligent matching and interviews</p>

                    {/* <!-- Main CTAs --> */}
                    <div className="hero-cta">
                        <a href="user/login" className="btn btn-primary btn-large">
                            I'm a Job Seeker
                        </a>
                        <a href="company/login" className="btn btn-outline btn-large">
                            I'm a Company
                        </a>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="grid grid-3">
                        ...
                        <div className="card">
                            ...
                            <p className="text-muted">Browse open positions, apply with your resume, and complete AI-powered interviews at your convenience.</p>
                        </div>

                        {/* <!-- Feature Card 2 --> */}
                        <div className="card">
                            <h3>AI Screening</h3>
                            <p className="text-muted">Our AI evaluates resumes and conducts initial interviews, providing fair and consistent assessments.</p>
                        </div>

                        {/* <!-- Feature Card 3 --> */}
                        <div className="card">
                            <h3>For Companies</h3>
                            <p className="text-muted">Post jobs, review AI-scored candidates, and focus on the best-fit applicants for your roles.</p>
                        </div>
                    </div>
                </div>
            </section>
